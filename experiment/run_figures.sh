...
./get_figures.py "samples" "test1" --ae-fpath models/autoencoder_42_42.pt --deblend-fpath models/deblender_42_42.pt --test-file-blends data/datasets/test_ds_23.npz --detection-fpath models/detection_42_42.pt
